import MainAbout from "@/data/MainAbout"
import Image from "next/image";
import Link from "next/link";


const {title, desc, img, button} = MainAbout;
...
const HomeAbout = () => {
  ...
  <div className="container mx-auto flex px-5 pt-24 md:flex-row flex-col-reverse items-center">
    ...
    <div className="lg:max-w-lg lg:w-full md:w-1/2 w-5/6 mb-4">
      <Image className="object-cover object-center rounded" alt="" src={img} height={720} width={600}/>
    </div>
  </div>
</section>
  )
