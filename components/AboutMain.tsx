...
const AboutMain = () => {
  ...
  <div className="container mx-auto flex px-5 items-center justify-center flex-col">
    ...
    <Image className="lg:w-2/6 md:w-3/6 w-5/6 mb-10 object-cover object-center rounded-full border-blue-600 border-4 shadow-md" alt="A person working for his clients" src={img} height={300} width={300}/>
